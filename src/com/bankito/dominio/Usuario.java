...
/**
* <h1>Usuario</h1>
* Esta clase representa la funcionalidad de un objeto Usuario de la capa de dominio.
* <p>
...
* de la clase Usuario que servirá para representar una consulta a la base de datos
...
* - findByIdUsuario: recupera un objeto de la clase desde la BD por su IdUsuario<br>
...
{
        public static final Usuario NOT_FOUND = new Usuario("vacio", "vacio");
	...
	public Usuario() {
        ...
        /**
         * Intenta hacer un login buscando el nombre de usuario en la base de 
         * datos y comparando si ambos passwords coinciden. Devuelve NOT_FOUND
         * en caso de no coincidir y el objeto Usuario en caso favorable.
         * @param nombre
         * @param password
         * @return Usuario
